<form action="http://www.datacenterdynamics.com/search/node/">
  <div id="searchbox-inner">
    ...
    {else}
    <input id="searchtext" name="SearchText" type="text" value="" size="12" class="textbox" />
    <input id="searchbutton" class="sbtbtn" type="submit" value="{'Search'|i18n('design/ezwebin/pagelayout')}" title="{'Search'|i18n('design/ezwebin/pagelayout')}" />
