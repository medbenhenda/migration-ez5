...
<link rel="alternate" href={"/"|ezurl} title="{'%sitetitle front page'|i18n('design/ezwebin/link',,hash('%sitetitle',$site.title))|wash}" />
<link rel="alternate" href={"/"|ezurl} />
<link rel="alternate"  href={"/"|ezurl} title="{$site_title}" />
