...
class dcdBasketInfoHandler
{
    /*!
     Constructor
    */
    function dcdBasketInfoHandler()
    {
    ...
    */
    function updatePriceInfo( $productCollectionID, &$basketInfo )
    {
        ...
        foreach ( $additionalShippingValues['shipping_vat_list'] as $vatValue => $additionalShippingValueArray )
        {
         ...
         /*   if ( !isset( $basketInfo['additional_info']['discounts'][$vatValue]['total_price_ex_vat'] ) )
            {
            	$basketInfo['additional_info']['discounts'][$vatValue]['total_price_ex_vat'] = $shippingExVAT;
            }
           */ 
