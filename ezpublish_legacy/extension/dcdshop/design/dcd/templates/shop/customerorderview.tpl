	...
	<div id="content">
		<article>
			<div class="shop-customerorderview">
				...
				<div class="attribute-header">
				    <h1 class="long">{"Order list"|i18n("design/ezwebin/shop/customerorderview")}</h1>
				</div>
				...
				{if $order_list}
					...
					<table class="list" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tr>
						    ...
						    <th>
						    {"Amount Enrolled"|i18n("dcd/shop/customerorderview")}
						    </th>
						    <th>
						...
						{def $enrolled_amount = get_enrolled_amount($item.id)}
						...
						<tr>
						    ...
						    <td>
						    		{$enrolled_amount.enrolled} / {$enrolled_amount.total}
							...
							<td>
								{if and($item.status_id|gt(1), $enrolled_amount.available|gt(0))}
				...
				<div class="attribute-header">
				  <h1 class="long">{"Purchase list"|i18n("design/ezwebin/shop/customerorderview")}</h1>
				</div>
