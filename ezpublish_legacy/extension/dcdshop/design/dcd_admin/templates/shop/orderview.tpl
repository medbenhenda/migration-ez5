...
<div class="block">
	<input class="button" type="button" name="EditButton" value="{'Edit'|i18n( 'design/admin/shop/orderview' )}" title="{'Edit this order.'|i18n( 'design/admin/shop/orderview' )}" onclick="location.href={concat("dcdshop/orderedit/", $order.id)|ezurl('single')};return false;"/>
</div>
