		...
		return this.each(function(){
			...
			if (option.generatePagination) {
				...
				if (option.prependPagination) {
					elem.prepend('<div id="pagination_wrapper"><ul class='+ option.paginationClass +'></ul></div>');
				} else {
					elem.append('<div id="pagination_wrapper"><ul class='+ option.paginationClass +'></ul></div>');
				}
