...
$oldSetArray_c7c480680f209b174b5eed2a9fa30d3f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '
<form id="clearcache" action="/ezdemo_site_admin/setup/cachetoolbar" method="post">';
...
$text .= ' type="submit" name="ClearCacheButton" value="Clear" />
</div>';
...
$setArray = $oldSetArray_c7c480680f209b174b5eed2a9fa30d3f;
$tpl->Level--;
?>
