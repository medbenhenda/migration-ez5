...
$oldSetArray_924e29a98e5ce6521a0506dcf8a08a10 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/templates/node/view/gallery_viewer.tpl (extension/ezdemo/design/ezdemo/templates/node/view/gallery_viewer.tpl) -->
';
// def $image
unset( $var );
unset( $var );
...
$text .= '
<!-- STOP: including template: extension/ezdemo/design/ezdemo/templates/node/view/gallery_viewer.tpl (extension/ezdemo/design/ezdemo/templates/node/view/gallery_viewer.tpl) -->
';

$setArray = $oldSetArray_924e29a98e5ce6521a0506dcf8a08a10;
$tpl->Level--;
?>
