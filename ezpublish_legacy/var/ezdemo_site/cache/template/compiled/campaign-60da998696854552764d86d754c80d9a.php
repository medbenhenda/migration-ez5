...
$oldSetArray_a86f49b0d0c70b2e657049deffbd7e67 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/override/templates/block/campaign.tpl (extension/ezdemo/design/ezdemo/override/templates/block/campaign.tpl) -->
';
// def $valid_nodes
unset( $var );
unset( $var );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/article-9f23c9e882ffaca2cfa92b19b05fe9e6.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/article-9f23c9e882ffaca2cfa92b19b05fe9e6.php' );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/image-c02d017f82e276bdb1b5b55a03d96e18.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/image-c02d017f82e276bdb1b5b55a03d96e18.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$text .= '
<!-- STOP: including template: extension/ezdemo/design/ezdemo/override/templates/block/campaign.tpl (extension/ezdemo/design/ezdemo/override/templates/block/campaign.tpl) -->
';

$setArray = $oldSetArray_a86f49b0d0c70b2e657049deffbd7e67;
$tpl->Level--;
?>
