<?php
// URI:       design/admin/templates/package/install_header.tpl
// Filename:  design/admin/templates/package/install_header.tpl
// Timestamp: 1359052386 (Thu Jan 24 19:33:06 CET 2013)
$oldSetArray_7bf40a72d0842ad1a181b65204c3e8d5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
    <input type="hidden" name="InstallerType" value="';
unset( $var );
unset( $var1 );
unset( $var1 );
...
$text .= '" />
    <input type="hidden" name="InstallStepID" value="';
unset( $var );
unset( $var1 );
unset( $var1 );
...
unset( $var4 );
unset( $var4 );
$var4 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'package', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['package'] : null;
...
$var2 = array( '%wizardname' => $var3 );unset( $var3 );
...
$var = strtr( 'Package install wizard: %wizardname', $var3 );
...
$setArray = $oldSetArray_7bf40a72d0842ad1a181b65204c3e8d5;
$tpl->Level--;
?>
