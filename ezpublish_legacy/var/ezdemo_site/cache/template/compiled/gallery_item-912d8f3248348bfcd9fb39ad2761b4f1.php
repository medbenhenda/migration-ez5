...
$oldSetArray_0b1747db6758197203ce8780e6487676 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/templates/node/view/gallery_item.tpl (extension/ezdemo/design/ezdemo/templates/node/view/gallery_item.tpl) -->
';
// def $big
unset( $var );
unset( $var );
...
$text .= '
<!-- STOP: including template: extension/ezdemo/design/ezdemo/templates/node/view/gallery_item.tpl (extension/ezdemo/design/ezdemo/templates/node/view/gallery_item.tpl) -->
';

$setArray = $oldSetArray_0b1747db6758197203ce8780e6487676;
$tpl->Level--;
?>
