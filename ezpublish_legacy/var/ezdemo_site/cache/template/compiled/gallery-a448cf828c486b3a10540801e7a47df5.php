...
$oldSetArray_5f8bd7e5269d34f49496d04f9e974254 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/override/templates/block/gallery.tpl (extension/ezdemo/design/ezdemo/override/templates/block/gallery.tpl) -->
';
// def $valid_nodes
unset( $var );
unset( $var );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/video-0b09f699c85e6b74a2fc27c532ea8905.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/video-0b09f699c85e6b74a2fc27c532ea8905.php' );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/gallery_viewer-e47724ff06d88580041f4701860f746c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/gallery_viewer-e47724ff06d88580041f4701860f746c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/video-d4d7c81cc269c3bf332c59bf5f1a7cad.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/video-d4d7c81cc269c3bf332c59bf5f1a7cad.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/gallery_item-912d8f3248348bfcd9fb39ad2761b4f1.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/gallery_item-912d8f3248348bfcd9fb39ad2761b4f1.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
<!-- STOP: including template: extension/ezdemo/design/ezdemo/override/templates/block/gallery.tpl (extension/ezdemo/design/ezdemo/override/templates/block/gallery.tpl) -->
';

$setArray = $oldSetArray_5f8bd7e5269d34f49496d04f9e974254;
$tpl->Level--;
?>
