...
$oldSetArray_73e0bf457ad92af990ade63688360bec = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/override/templates/block_item_campaign/article.tpl (extension/ezdemo/design/ezdemo/override/templates/block_item_campaign/article.tpl) -->
';
// def $image
unset( $var );
unset( $var );
...
$text .= '
<!-- STOP: including template: extension/ezdemo/design/ezdemo/override/templates/block_item_campaign/article.tpl (extension/ezdemo/design/ezdemo/override/templates/block_item_campaign/article.tpl) -->
';

$setArray = $oldSetArray_73e0bf457ad92af990ade63688360bec;
$tpl->Level--;
?>
