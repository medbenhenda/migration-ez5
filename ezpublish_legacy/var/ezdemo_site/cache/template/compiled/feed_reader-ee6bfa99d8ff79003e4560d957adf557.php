...
$oldSetArray_a30c767096728cced8e07022fabe7130 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/override/templates/block/feed_reader.tpl (extension/ezdemo/design/ezdemo/override/templates/block/feed_reader.tpl) -->
';
// def $source
unset( $var );
unset( $var );
...
<!-- STOP: including template: extension/ezdemo/design/ezdemo/override/templates/block/feed_reader.tpl (extension/ezdemo/design/ezdemo/override/templates/block/feed_reader.tpl) -->
';

$setArray = $oldSetArray_a30c767096728cced8e07022fabe7130;
$tpl->Level--;
?>
