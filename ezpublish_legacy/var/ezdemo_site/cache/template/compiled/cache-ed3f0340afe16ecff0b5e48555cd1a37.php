...
$oldSetArray_a87f90af814af6ce58153445fc3c393e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="clearcacheform" method="post" action="/ezdemo_site_admin/setup/cache">
...
$setArray = $oldSetArray_a87f90af814af6ce58153445fc3c393e;
$tpl->Level--;
?>
