<?php
// URI:       design:package/upload.tpl
// Filename:  design/admin/templates/package/upload.tpl
// Timestamp: 1359052386 (Thu Jan 24 19:33:06 CET 2013)
$oldSetArray_7ad6686c288adddea9fe5a81e2b5b1ee = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $show );
unset( $show );
$show = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'error_list', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['error_list'] : null;
...
<h1 class="context-title">Upload package</h1>
...
<form enctype="multipart/form-data" method="post" action="/ezdemo_site_admin/package/upload">

    <p>Select the file containing the package then click the upload button</p>
...
<div class="box-bc"><div class="box-ml">
    ...
    <div class="block">
        <input class="button" type="submit" name="UploadPackageButton" value="Import package" />
        <input class="button" type="submit" name="UploadCancelButton" value="Cancel" />
    </div>
...
$setArray = $oldSetArray_7ad6686c288adddea9fe5a81e2b5b1ee;
$tpl->Level--;
?>
