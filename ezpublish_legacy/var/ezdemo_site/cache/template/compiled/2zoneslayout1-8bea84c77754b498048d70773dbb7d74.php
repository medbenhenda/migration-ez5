...
$oldSetArray_83108232e6b2bc07f3e332d7f43a9b22 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/templates/zone/2zoneslayout1.tpl (design:zone/2zoneslayout1.tpl) -->
...
$text .= '                ';
$oldRestoreIncludeArray_69d75c88795aaa86d15bf402b8631025 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/zone_block-f0fdfed34f6cda2eb0a3ecf45cae4102.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/zone_block-f0fdfed34f6cda2eb0a3ecf45cae4102.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_69d75c88795aaa86d15bf402b8631025;
...
$text .= '                    ';
$oldRestoreIncludeArray_374db63fcc03d78e43bdcfbf77bf18b6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_374db63fcc03d78e43bdcfbf77bf18b6;
...
<!-- STOP: including template: extension/ezdemo/design/ezdemo/templates/zone/2zoneslayout1.tpl (design:zone/2zoneslayout1.tpl) -->
';

$setArray = $oldSetArray_83108232e6b2bc07f3e332d7f43a9b22;
$tpl->Level--;
?>
