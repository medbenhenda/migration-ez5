...
$oldSetArray_f1f529b9409a2238d25e7cdd8e381788 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezdemo/design/ezdemo/override/templates/block/content_grid_1col_2rows.tpl (extension/ezdemo/design/ezdemo/override/templates/block/content_grid_1col_2rows.tpl) -->
';
// def $valid_nodes
unset( $var );
unset( $var );
...
$text .= '
<!-- STOP: including template: extension/ezdemo/design/ezdemo/override/templates/block/content_grid_1col_2rows.tpl (extension/ezdemo/design/ezdemo/override/templates/block/content_grid_1col_2rows.tpl) -->
';

$setArray = $oldSetArray_f1f529b9409a2238d25e7cdd8e381788;
$tpl->Level--;
?>
