...
$oldSetArray_f430952c9e35ebd3c371de9a0596803b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezflow/design/standard/templates/block/view/view.tpl (design:block/view/view.tpl) -->
';
// def $valid_nodes
unset( $var );
unset( $var );
...
$text .= '
<!-- STOP: including template: extension/ezflow/design/standard/templates/block/view/view.tpl (design:block/view/view.tpl) -->
';

$setArray = $oldSetArray_f430952c9e35ebd3c371de9a0596803b;
$tpl->Level--;
?>
