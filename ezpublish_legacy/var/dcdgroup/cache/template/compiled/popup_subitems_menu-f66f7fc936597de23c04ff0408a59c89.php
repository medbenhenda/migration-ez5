...
$oldSetArray_ea8a1326bbe67e29134440def50e7620 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/popupmenu/popup_subitems_menu.tpl (design/admin/templates/popupmenu/popup_subitems_menu.tpl) -->
...
$text .= '</div>
<!-- STOP: including template: design/admin/templates/popupmenu/popup_subitems_menu.tpl (design/admin/templates/popupmenu/popup_subitems_menu.tpl) -->
';

$setArray = $oldSetArray_ea8a1326bbe67e29134440def50e7620;
$tpl->Level--;
?>
