...
$oldSetArray_e991c6a66c38d01e9b1a0c792180bc2d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/parts/content/menu.tpl (design:parts/content/menu.tpl) -->
<div id="content-tree">
...
<div id="contentstructure">
    ';
$oldRestoreIncludeArray_2d1e17c77b4ce61743bc9cda4c58c4e7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/content_structure_menu_dynamic-12a504bb3a8be0f9a4741014673bc78a.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/dcdgroup/cache/template/compiled/content_structure_menu_dynamic-12a504bb3a8be0f9a4741014673bc78a.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_2d1e17c77b4ce61743bc9cda4c58c4e7;
...
';
$oldRestoreIncludeArray_b3bbafd374d8043e091995f74be64681 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/ini_menu-df0a83ad744c937b6b2d1febe1a3cc66.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/dcdgroup/cache/template/compiled/ini_menu-df0a83ad744c937b6b2d1febe1a3cc66.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_b3bbafd374d8043e091995f74be64681;
...
<!-- STOP: including template: design/admin/templates/parts/content/menu.tpl (design:parts/content/menu.tpl) -->
';

$setArray = $oldSetArray_e991c6a66c38d01e9b1a0c792180bc2d;
$tpl->Level--;
?>
