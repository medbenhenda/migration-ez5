...
$oldSetArray_92aacdefd5634c3d167ef1fbe0e108e9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/relations.tpl (design/admin/templates/relations.tpl) -->
';
// def $page_limit
unset( $var );
unset( $var1 );
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/text_linked-277f86fa9f77c1120b87d2624028b073.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/dcdgroup/cache/template/compiled/text_linked-277f86fa9f77c1120b87d2624028b073.php' );
...
$text .= '</td>
            <td>
                ';
unset( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99 );
unset( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 );
unset( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 );
$elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_id'] : null;
if (! isset( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 ) ) $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 = NULL;
while ( is_object( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 ) and method_exists( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991, 'templateValue' ) )
    $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 = $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991->templateValue();
while ( is_object( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 ) and method_exists( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991, 'templateValue' ) )
    $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 = $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991->templateValue();
$elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99 = ( ( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 ) == ( 0 ) );
unset( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_991 );
if (! isset( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99 ) ) $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99 = NULL;
while ( is_object( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99 ) and method_exists( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99, 'templateValue' ) )
    $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99 = $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99->templateValue();
...
elseif ( $elseif_cond_f7d54e3bf684e011bf56b2b03b8f70fb_99 )
{
$text .= '                    ';
// def $relation_name_array
if ( $tpl->hasVariable( 'relation_name_array', $rootNamespace ) )
...
$text .= '</table>';
$oldRestoreIncludeArray_25aeb5b4ec66c0ff1143cf0fe60a3015 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/google-8fbe39e95f86b57c9e2bf9eeed6a7e72.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/dcdgroup/cache/template/compiled/google-8fbe39e95f86b57c9e2bf9eeed6a7e72.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_25aeb5b4ec66c0ff1143cf0fe60a3015;

$text .= '
<!-- STOP: including template: design/admin/templates/relations.tpl (design/admin/templates/relations.tpl) -->
';

$setArray = $oldSetArray_92aacdefd5634c3d167ef1fbe0e108e9;
$tpl->Level--;
?>
