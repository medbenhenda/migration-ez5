...
$oldSetArray_0752628feee3e3c6ae5bc6b666df6fbe = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/eztags/design/admin2/templates/popupmenu/popup_tag_menu.tpl (design:popupmenu/popup_tag_menu.tpl) -->
';
// def $tags_add_access
unset( $var );
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-child-tag\'] = { \'url\': "/ezdemo_site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'edit-tag\'] = { \'url\': "/ezdemo_site_admin/tags/edit/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'delete-tag\'] = { \'url\': "/ezdemo_site_admin/tags/delete/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'merge-tag\'] = { \'url\': "/ezdemo_site_admin/tags/merge/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-synonym-tag\'] = { \'url\': "/ezdemo_site_admin/tags/addsynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'make-synonym-tag\'] = { \'url\': "/ezdemo_site_admin/tags/makesynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$text .= '    menuArray[\'TagMenuSimple\'] = { \'depth\': 0, \'headerID\': \'tag-simple-header\' };
    ...
    menuArray[\'TagMenuSimple\'][\'elements\'][\'add-child-tag-simple\'] = { \'url\': "/ezdemo_site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$text .= '
<!-- STOP: including template: extension/eztags/design/admin2/templates/popupmenu/popup_tag_menu.tpl (design:popupmenu/popup_tag_menu.tpl) -->
';

$setArray = $oldSetArray_0752628feee3e3c6ae5bc6b666df6fbe;
$tpl->Level--;
?>
