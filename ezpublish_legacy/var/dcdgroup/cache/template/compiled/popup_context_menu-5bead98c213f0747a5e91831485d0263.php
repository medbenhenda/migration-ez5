...
$oldSetArray_9699c51488619811f478acf26aafd03d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/popupmenu/popup_context_menu.tpl (design/admin/templates/popupmenu/popup_context_menu.tpl) -->
<!-- Treemenu icon click popup menu -->
<script type="text/javascript">
menuArray[\'ContextMenu\'] = { \'depth\': 0, \'headerID\': \'menu-header\' };
menuArray[\'ContextMenu\'][\'elements\'] = {};
//menuArray[\'ContextMenu\'][\'elements\'][\'menu-view\'] = { \'url\': "/ezdemo_site_admin/content/view/full/%nodeID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-edit\'] = { \'url\': "/ezdemo_site_admin/content/edit/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy\'] = { \'url\': "/ezdemo_site_admin/content/copy/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy-subtree\']= { \'url\': "/ezdemo_site_admin/content/copysubtree/%nodeID%" };
...
$text .= '</div>
<!-- STOP: including template: design/admin/templates/popupmenu/popup_context_menu.tpl (design/admin/templates/popupmenu/popup_context_menu.tpl) -->
';

$setArray = $oldSetArray_9699c51488619811f478acf26aafd03d;
$tpl->Level--;
?>
