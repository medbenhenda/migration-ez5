...
$oldSetArray_2c1afe5960c933d90a22704ff44c3b17 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/children.tpl (design/admin/templates/children.tpl) -->
...
<form name="children" method="post" action="/ezdemo_site_admin/content/action">
...
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
$var = $var1 ? $var3 : '"/ezdemo_site_admin"';
unset( $var1, $var3 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$text .= '
    ...
    ';
$oldRestoreIncludeArray_f714dbc941fe7deb9be67aa4fac46b51 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/children_detailed-9f1bf684dda25b0774fa0dc02f481c10.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/dcdgroup/cache/template/compiled/children_detailed-9f1bf684dda25b0774fa0dc02f481c10.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_f714dbc941fe7deb9be67aa4fac46b51;
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_cbec62867fc6f21919fa4ec42ed63cde = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/alphabetical-5dbc6f40e507335aa8252f053203b551.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/dcdgroup/cache/template/compiled/alphabetical-5dbc6f40e507335aa8252f053203b551.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_cbec62867fc6f21919fa4ec42ed63cde;
...
<!-- STOP: including template: design/admin/templates/children.tpl (design/admin/templates/children.tpl) -->
';

$setArray = $oldSetArray_2c1afe5960c933d90a22704ff44c3b17;
$tpl->Level--;
?>
