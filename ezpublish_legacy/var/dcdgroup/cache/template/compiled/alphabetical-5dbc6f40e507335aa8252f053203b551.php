...
$oldSetArray_5de6886ed434d2b8d3ea633eb8681c31 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/navigator/alphabetical.tpl (design/admin/templates/navigator/alphabetical.tpl) -->
';
...
{
$text .= '    ';
$oldRestoreIncludeArray_0d5f4a94bcdf93fc34551b85200ae095 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_0d5f4a94bcdf93fc34551b85200ae095;
...
$text .= '
<!-- STOP: including template: design/admin/templates/navigator/alphabetical.tpl (design/admin/templates/navigator/alphabetical.tpl) -->
';

$setArray = $oldSetArray_5de6886ed434d2b8d3ea633eb8681c31;
$tpl->Level--;
?>
