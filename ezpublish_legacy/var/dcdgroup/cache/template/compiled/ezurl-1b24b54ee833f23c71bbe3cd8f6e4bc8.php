...
$oldSetArray_2a9cf853afb83945c5252b04dbdd9355 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/standard/templates/content/datatype/view/ezurl.tpl (design:content/datatype/view/ezurl.tpl) -->
';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$text .= '
<!-- STOP: including template: design/standard/templates/content/datatype/view/ezurl.tpl (design:content/datatype/view/ezurl.tpl) -->
';

$setArray = $oldSetArray_2a9cf853afb83945c5252b04dbdd9355;
$tpl->Level--;
?>
