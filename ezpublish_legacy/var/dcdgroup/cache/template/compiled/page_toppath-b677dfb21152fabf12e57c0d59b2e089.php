...
$oldSetArray_b77ce329ca8ec1fa8ca92e420ea31539 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/page_toppath.tpl (design/admin/templates/page_toppath.tpl) -->
';
...
$text .= '
<!-- STOP: including template: design/admin/templates/page_toppath.tpl (design/admin/templates/page_toppath.tpl) -->
';

$setArray = $oldSetArray_b77ce329ca8ec1fa8ca92e420ea31539;
$tpl->Level--;
?>
