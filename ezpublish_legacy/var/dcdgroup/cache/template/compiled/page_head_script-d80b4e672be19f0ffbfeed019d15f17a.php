...
$oldSetArray_e5bc3a479384bc148b10b1beada2b72c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/page_head_script.tpl (design/admin/templates/page_head_script.tpl) -->
...
$text .= '
<!-- STOP: including template: design/admin/templates/page_head_script.tpl (design/admin/templates/page_head_script.tpl) -->
';

$setArray = $oldSetArray_e5bc3a479384bc148b10b1beada2b72c;
$tpl->Level--;
?>
