...
$oldSetArray_e0241df6cb90e848afe3b2e44599eb45 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/page_head_style.tpl (design/admin/templates/page_head_style.tpl) -->
...
$text .= '
  ';
$oldRestoreIncludeArray_49ac2ca5b3f6cf0a13c29b06eafa60de = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/page_head_style_inline-4c2378ef11875cf6e4c07d756db45e73.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/dcdgroup/cache/template/compiled/page_head_style_inline-4c2378ef11875cf6e4c07d756db45e73.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_49ac2ca5b3f6cf0a13c29b06eafa60de;
...
$text .= '
<!-- STOP: including template: design/admin/templates/page_head_style.tpl (design/admin/templates/page_head_style.tpl) -->
';

$setArray = $oldSetArray_e0241df6cb90e848afe3b2e44599eb45;
$tpl->Level--;
?>
