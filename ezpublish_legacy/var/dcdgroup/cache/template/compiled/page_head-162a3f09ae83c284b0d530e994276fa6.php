...
$oldSetArray_130ec986eb9cf995747f7446872c2ca0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '  ';
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'module_result', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['module_result'] : null;
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1472 = compiledFetchAttribute( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471, 'title_path' );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1472;
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471->templateValue();
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471->templateValue();
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_147 = isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 );unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1471 );
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147->templateValue();
...
elseif ( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_147 )
{
$text .= '    ';
unset( $var );
unset( $var );
...
{
$text .= '    ';
$oldRestoreIncludeArray_54634b3fbf0f2ce7d16f298ae343cf12 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/canonical_link-922b020d4f96a28f8c7abc01cde56de3.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/dcdgroup/cache/template/compiled/canonical_link-922b020d4f96a28f8c7abc01cde56de3.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_54634b3fbf0f2ce7d16f298ae343cf12;
...
{
$text .= '    ';
$oldRestoreIncludeArray_c178b1247a04dc450b549e20574a70c4 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/link-5f8e5eb723f4889f5748230c13bead5d.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/dcdgroup/cache/template/compiled/link-5f8e5eb723f4889f5748230c13bead5d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_c178b1247a04dc450b549e20574a70c4;
...
$setArray = $oldSetArray_130ec986eb9cf995747f7446872c2ca0;
$tpl->Level--;
?>
