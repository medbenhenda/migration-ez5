...
$oldSetArray_f61d54bc06d125c948f6f1c3beb67259 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/user/login.tpl (design:user/login.tpl) -->
';
// if begins
unset( $if_cond );
...
<form name="loginform" method="post" action="/ezdemo_site_admin/user/login">
...
<div class="block">
    ...
    <div class="login-text-wrapper">
        or
        <br/>
        <a href="/ezdemo_site_admin/user/register">Register new account</a>
    </div>
</div>
</div></div>
</div>
...
<!-- STOP: including template: design/admin/templates/user/login.tpl (design:user/login.tpl) -->
';

$setArray = $oldSetArray_f61d54bc06d125c948f6f1c3beb67259;
$tpl->Level--;
?>
