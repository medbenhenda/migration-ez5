...
$oldSetArray_dcf55c45a256a8ff7027b6b83ca9f601 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/details.tpl (design/admin/templates/details.tpl) -->
<div class="block">
...
<!-- STOP: including template: design/admin/templates/details.tpl (design/admin/templates/details.tpl) -->
';

$setArray = $oldSetArray_dcf55c45a256a8ff7027b6b83ca9f601;
$tpl->Level--;
?>
