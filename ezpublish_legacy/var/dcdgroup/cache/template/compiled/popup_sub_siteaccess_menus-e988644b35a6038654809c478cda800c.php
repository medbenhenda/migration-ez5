...
$oldSetArray_43c93a8edd97cfc9c200fe997d76b026 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/popupmenu/popup_sub_siteaccess_menus.tpl (design/admin/templates/popupmenu/popup_sub_siteaccess_menus.tpl) -->
';
// def $siteAccessList
...
unset( $loopKeys, $loopCount, $index, $last, $loopIndex, $loopItem );
$text .= '</div>
<!-- STOP: including template: design/admin/templates/popupmenu/popup_sub_siteaccess_menus.tpl (design/admin/templates/popupmenu/popup_sub_siteaccess_menus.tpl) -->
';

$setArray = $oldSetArray_43c93a8edd97cfc9c200fe997d76b026;
$tpl->Level--;
?>
