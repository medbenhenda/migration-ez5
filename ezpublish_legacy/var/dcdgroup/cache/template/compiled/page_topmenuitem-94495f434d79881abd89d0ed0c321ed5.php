...
$oldSetArray_3abc75fc4e857c7b3ec2cff946419a92 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/page_topmenuitem.tpl (design/admin/templates/page_topmenuitem.tpl) -->
';
// def $liclass
...
$text .= '
<!-- STOP: including template: design/admin/templates/page_topmenuitem.tpl (design/admin/templates/page_topmenuitem.tpl) -->
';

$setArray = $oldSetArray_3abc75fc4e857c7b3ec2cff946419a92;
$tpl->Level--;
?>
