...
$oldSetArray_15d48a0115336145303c32ed20b78600 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/page_leftmenu.tpl (design/admin/templates/page_leftmenu.tpl) -->
<div id="leftmenu">
...
<hr class="hide" />
<!-- STOP: including template: design/admin/templates/page_leftmenu.tpl (design/admin/templates/page_leftmenu.tpl) -->
';

$setArray = $oldSetArray_15d48a0115336145303c32ed20b78600;
$tpl->Level--;
?>
