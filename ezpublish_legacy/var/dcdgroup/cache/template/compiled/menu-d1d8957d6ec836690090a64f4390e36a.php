...
$oldSetArray_c470912c11031de8cb1b9ccecd74d9b9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/parts/setup/menu.tpl (design:parts/setup/menu.tpl) -->

';
$oldRestoreIncludeArray_18bbbb2571f6edcfce59edf6ae17650a = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_18bbbb2571f6edcfce59edf6ae17650a;
...
<!-- STOP: including template: design/admin/templates/parts/setup/menu.tpl (design:parts/setup/menu.tpl) -->
';

$setArray = $oldSetArray_c470912c11031de8cb1b9ccecd74d9b9;
$tpl->Level--;
?>
