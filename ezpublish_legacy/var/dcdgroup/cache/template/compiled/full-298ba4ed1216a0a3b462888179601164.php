...
$oldSetArray_d6a4b4b842c598eca6b2e09ab88b4c4d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/admin/templates/node/view/full.tpl (design:node/view/full.tpl) -->
...
$text .= '">
';
$oldRestoreIncludeArray_2d88d0cc79900bda46998648e524bf74 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/infocollection_validation-6f41f80d4a4a365bc9d3c2984704b85a.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/dcdgroup/cache/template/compiled/infocollection_validation-6f41f80d4a4a365bc9d3c2984704b85a.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_2d88d0cc79900bda46998648e524bf74;
...
';
$oldRestoreIncludeArray_0641b9623d512c6a6823aabb9b8aaec7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/window_controls-3ff10b9e7738fc6c3534d5c40b0f2ce7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/dcdgroup/cache/template/compiled/window_controls-3ff10b9e7738fc6c3534d5c40b0f2ce7.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0641b9623d512c6a6823aabb9b8aaec7;
...
<form method="post" action="/ezdemo_site_admin/content/action">
...
{
$text .= '    ';
$oldRestoreIncludeArray_8154e06a132740389b17ed409ca6b5f1 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/children-cdf3560ae91ce2ead51806a74b66ad91.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/dcdgroup/cache/template/compiled/children-cdf3560ae91ce2ead51806a74b66ad91.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_8154e06a132740389b17ed409ca6b5f1;

}
else
{
$text .= '    ';
$oldRestoreIncludeArray_42ec15cd9b27c5d4beaabbd6823f7840 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/dcdgroup/cache/template/compiled/no_children-80696891fdd8b68024d79aed4251cab1.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/dcdgroup/cache/template/compiled/no_children-80696891fdd8b68024d79aed4251cab1.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_42ec15cd9b27c5d4beaabbd6823f7840;
...
<!-- STOP: including template: design/admin/templates/node/view/full.tpl (design:node/view/full.tpl) -->
';

$setArray = $oldSetArray_d6a4b4b842c598eca6b2e09ab88b4c4d;
$tpl->Level--;
?>
